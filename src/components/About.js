...
export default function About() {
  return (
    <section id="about">
      <div className="container px-4 mx-auto flex sm:px-10 sm:py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-center">
            ...
            <a
              href="#projects"
              className="ml-4 inline-flex bg-background border-0 py-2 px-6 focus:outline-none hover:bg-hover hover:text-white rounded-lg text-lg">
              See my past work
            </a>
          </div>
          </div>
